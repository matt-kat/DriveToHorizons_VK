...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/DriveToHorizons_VK.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/DriveToHorizons_VK.data.br',
                        frameworkUrl: 'Build/DriveToHorizons_VK.framework.js.br',
                        codeUrl: 'Build/DriveToHorizons_VK.wasm.br',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'MKPlay.Simulator.DriveBeyondHorizons.Race',
                        productName: 'LongDrivetoHorizonsSim',
                        productVersion: '0.11',
